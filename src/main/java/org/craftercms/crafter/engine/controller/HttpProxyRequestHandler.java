...
import org.craftercms.crafter.engine.exception.HttpStatusCodeException;
import org.craftercms.crafter.engine.http.HttpProxy;
import org.craftercms.crafter.engine.http.HttpProxyRegistry;
...
/**
 * All requests served by this handler will be proxied through a {@link HttpProxy}, determined by the {proxyName} URI template var.
 *
