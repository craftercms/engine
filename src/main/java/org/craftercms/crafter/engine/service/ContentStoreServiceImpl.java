...
import org.craftercms.crafter.core.exception.*;
import org.craftercms.crafter.core.processors.ItemProcessor;
import org.craftercms.crafter.core.service.*;
import org.craftercms.crafter.core.store.ContentStoreAdapter;
import org.craftercms.crafter.core.xml.mergers.DescriptorMergeStrategy;
...
/**
 * Override {@link org.craftercms.crafter.core.service.impl.ContentStoreServiceImpl} with
 * fallback site logic. For example, the fallback site of 'test-fr' is 'test'.
 *
 * @author Russ Danner, Michael Chen
 */
public class ContentStoreServiceImpl extends org.craftercms.crafter.core.service.impl.ContentStoreServiceImpl
{
            ...
            XmlFileParseException, XmlMergeException, ItemProcessingException, StoreException
    {
        ...
        Map<String, Item> itemMap = new java.util.HashMap<String, Item>();
        String currentSite = getSiteName();
        String siteFolders = macroResolver.resolveMacros(sitePathPrefix);
