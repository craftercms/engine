...
import static org.craftercms.core.util.HttpServletUtils.SCOPE_SESSION;
...
public class PreviewAuthenticationTokenResolvingProcessor implements RequestSecurityProcessor {
    ...
    public void processRequest(RequestContext context, RequestSecurityProcessorChain processorChain) throws Exception {
        UserProfile profile;
        Map<String, Object> attributes = (Map<String, Object>) HttpServletUtils.getAttribute(ProfileRestController.PROFILE_SESSION_ATTRIBUTE, SCOPE_SESSION);
