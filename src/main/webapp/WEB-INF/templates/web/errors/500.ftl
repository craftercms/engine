...
<main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
        ...
        <p class="mt-6 text-base leading-7 text-gray-600">Oops! A server error has occurred and we were unable to fulfill the request.<br/>
            Please try again. If the error persists, contact the administrator of the site.</p>
        ...
        <#if modePreview>
            <div class="text-sm font-semibold text-gray-900 mt-10">
                <a href="#" id="stackTraceToggleButton">Expand stack trace</a>
            </div>
            <div id="stackTraceContent" class="mt-10" style="display: none">
...
<script>
    ...
    const content = document.getElementById('stackTraceContent');
    toggleButton.addEventListener('click', (e) => {
        e.preventDefault();
        const currentState = content.style.display;
